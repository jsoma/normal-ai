...
Text classification is one of the most basic yet most useful machine learning methods: it's the proces of putting pieces of text into categories.
...
Any modern language model works fine for this. [You can find plenty on Hugging Face](https://huggingface.co/models?pipeline_tag=text-classification&sort=downloads), they'll typically be something with BERT or LM in the name.

### State of the art

The majority of the time our text classifiers are going to be fine-tuned versions of common large language models. The capability of our classifier isn't going to be restrained by the model we choose – they're all pretty good! – but rather by how much of our dataset we manually categorize. The more the better!

To learn more, check out [building your own text classifier](../diy/text-classification.qmd).