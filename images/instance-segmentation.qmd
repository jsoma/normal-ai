...
::: {.callout-warning}
Yes, this is the object detection page but the image is more or less *panoptic segmentation*, which detects both the objects and what pixels make them up. It's like this plus [semantic segmentation](semantic-segmentation.qmd).
:::
