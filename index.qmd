...
There's a legitimate answer to this, but *generally speaking* artificial intelligence is just machine learing with a better marketing team behind it.

So is there an actual technical differentiation to be made? Absolutely! Does this difference have any sort of meaningful impact on literally anything? Absolutely not!
...
1. Sigh, yes. At least to a degree.
2. Most of these fancy all-powerful multimodal models are currently only found behind paywalls and locked up by mega-corporations (although [that definitely won't last](https://github.com/cocktailpeanut/dalai))
3. The more basic, one-task models you'll find here are usually lighter, faster, and can run easily on your own computer
