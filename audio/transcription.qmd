...
Here we will try using the [large version of the Whisper model](https://huggingface.co/spaces/sanchit-gandhi/whisper-large-v2), which should give excellent results over many languages.
